...
function addMovie() {
     let addMovieName = document.getElementById("addMovieName").value;
     let addMovieImage = document.getElementById("addMovieImage").value;
     let newMovie = new MovieList(addMovieName, addMovieImage)
